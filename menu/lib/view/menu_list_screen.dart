                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        menus[index].name!.length >
                                                nameMaxLength
                                            ? '${menus[index].name!.substring(0, nameMaxLength)}...'
                                            : menus[index].name!,
                                        style: TextStyle(
                                            color: Colors.black,
                                            fontSize: 18,
                                  ...
                                  //2列目(最近食べた日）
                                  Text(
                                    "最近食べた日:${menus[index].dinnerDate != null ? DateFormat('yyyy/MM/dd(E)', 'ja').format(menus[index].dinnerDate!) : "ー"}",
                                    style: TextStyle(
                                      fontSize: 10,
                                  ...
                                  //3列目(メモ）
                                  Text(
                                    menus[index].memo!.length > 37
                                        ? '${menus[index].memo!.substring(0, 37)}...'
                                        : menus[index].memo!,
