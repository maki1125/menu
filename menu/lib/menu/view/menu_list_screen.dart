                ...
                children: [
                  ...
                  Expanded(
                    child:SingleChildScrollView(
                      child:(matchedMenus.isEmpty && category!='夕食') 
                      // データがない場合
                      ? const Padding(
                      ...
                      : ListView.builder(
                        ...
                        itemBuilder: (context, index){
                          ...
                          if(index < matchedMenus.length){
                                                ...
                                                ? Consumer(builder: (BuildContext context, WidgetRef ref, child){
                                                  ...
                                                  return Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      //マイナスアイコンーーーーーーーーーーーーーーーーーーーーーーー
                                                      IconButton(
                                                        onPressed: () {
                                                      ...
                                                      //何人前の表示ーーーーーーーーーーーーーーーーーーーーーーーーーーー
                                                      SizedBox(
                                                        width: 50,
                                                        child: Column(
                                                          children: [
                                                      ...
                                                      //プラスアイコンーーーーーーーーーーーーーーーーーーーーーーーーーーーーーー
                                                      IconButton(
                                                        onPressed: () {
                                                          ref.read(quantityProvider(index).notifier).state = dispQuantity + 1;
                                                        },
                                      ...
                                      Expanded(
                                        ...
                                        child: Stack(//お気に入りアイコンのためにstack使用
                                          children: [
                                            ...
                                            //お気に入りアイコンーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーー
                                            Positioned(
                                              top: 0,
                                              right: 0,
                                              child: IconButton(
                            ...
                            //「夕食」カード下の表示　※「夕食」タブのみーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーー
                            }else{
                              return category == '夕食'
                              ? Column(
                              children: [
