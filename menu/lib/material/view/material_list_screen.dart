                  ...
                  materialList.when(
                    data: (materials) {
                      ...
                      return Column(
                        children: [
                          // 検索テキストフィールド---------------------------------------
                          _buildTextField(searchController, ref, materials),
                              ...
                              return Card(
                                  ...
                                  child: Stack(//タップ可能領域とアイコンを切り分けるためにstack使用
                                    ...
                                    IgnorePointer(
                                        //タップできる条件をつける。
                                        ignoring: ref
                                                .read(selectMaterialProvider
                                                    .notifier)
                                                .state ==
                                            0, //「材料一覧から選択」時以外はタッチ不可能にする。
                                        child: InkWell(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          IconButton(
                                            ...
                                            onPressed: () {
                                              MaterialRepository()
                                                  .deleteMaterial(MaterialModel
                                                      .fromFirestore(material));
                                            },
                                          ),
                                        ],
                                      ),
